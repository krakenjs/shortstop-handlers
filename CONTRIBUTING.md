# Contributing To shortstop-handlers
...
```bash
# Clone it
$ git clone git@github.com:me/shortstop-handlers.git

# Change directory
$ cd shortstop-handlers

# Add the upstream repo
$ git remote add upstream git://github.com/paypal/shortstop-handlers.git
